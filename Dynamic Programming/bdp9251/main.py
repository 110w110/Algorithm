# def recursionLCS(X, Y, R):
#     if len(X)==0 or len(Y)==0 :
#         return R
#     elif X[-1:]==Y[-1:]:
#         R = recursionLCS(X[0:-1],Y[0:-1],R) + X[-1:]
#         return R
#     else :
#         Left = recursionLCS(X[0:-1],Y,R)
#         Right = recursionLCS(X,Y[0:-1],R)
...
# m = len(B)
#
# # result = recursionLCS(A, B, S)
# # print(result)
# # print(len(result))
#
# O = [[0 for x in range(n)] for y in range(m)]
